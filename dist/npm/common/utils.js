...
var deriveKeypair = require('../../../pack/call-keypairs').deriveKeypair;
...
function callToDrops(call) {
    return (new bignumber_js_1.default(call)).times(1000000.0).floor().toString();
}
