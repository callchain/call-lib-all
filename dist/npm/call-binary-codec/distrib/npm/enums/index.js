...
var _require = require('./../utils/bytes-utils'), parseBytes = _require.parseBytes, serializeUIntN = _require.serializeUIntN;
    ...
    statics: {
        ...
        valuesByName: function valuesByName() {
            ...
            var fields = _.map(this.initVals, function (_ref) {
                var _ref2 = _slicedToArray(_ref, 2), name = _ref2[0], definition = _ref2[1];
