...
var _require = require('./serialized-type'), Comparable = _require.Comparable, SerializedType = _require.SerializedType;
var _require2 = require('../utils/bytes-utils'), compareBytes = _require2.compareBytes, parseBytes = _require2.parseBytes;
var Hash = makeClass({
