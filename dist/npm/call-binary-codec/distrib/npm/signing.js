...
var _require = require('./types'), AccountID = _require.AccountID;
var binary = require('./binary');
var serializeObject = binary.serializeObject, bytesToHex = binary.bytesToHex, multiSigningData = binary.multiSigningData, transactionID = binary.transactionID, signingData = binary.signingData;
...
function signFor(tx_json_, keyPair) {
    var signingAccount = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
