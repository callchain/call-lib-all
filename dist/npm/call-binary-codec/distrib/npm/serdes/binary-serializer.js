...
var _require = require('../utils/bytes-utils'), parseBytes = _require.parseBytes, bytesToHex = _require.bytesToHex;
var makeClass = require('../utils/make-class');
var _require2 = require('../enums'), Type = _require2.Type, Field = _require2.Field;
var BytesSink = {
    put: function put() {
