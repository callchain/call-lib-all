...
var bytesUtils = require('../src/utils/bytes-utils');
var slice = bytesUtils.slice, compareBytes = bytesUtils.compareBytes, parseBytes = bytesUtils.parseBytes, bytesToHex = bytesUtils.bytesToHex;
describe('bytes-utils', function () {
    ...
    describe('compareBytes', function () {
        ...
        it('throws when the bytes sequences are of unlike length', function () {
            assert.throws(function () { return compareBytes([0, 1], [1]); });
        });
    });
...
//# sourceMappingURL=bytes-utils-test.js.map