...
var _a = require('../src'), encodeForSigning = _a.encodeForSigning, encodeForSigningClaim = _a.encodeForSigningClaim, encodeForMultisigning = _a.encodeForMultisigning;
var tx_json = {
...
describe('Signing data', function () {
    it('can create single signing blobs', function () {
        var actual = encodeForSigning(tx_json);
        assert.equal(actual, ['53545800',
            // TransactionType
            '12',
            '0000',
            // Flags
    ...
    it('can create multi signing blobs', function () {
        ...
        var signingJson = _.assign({}, tx_json, { SigningPubKey: '' });
        var actual = encodeForMultisigning(signingJson, signingAccount);
        assert.equal(actual, ['534D5400',
            // TransactionType
            '12',
            '0000',
            // Flags
    ...
    it('can create claim blob', function () {
        ...
        var amount = '1000';
        var json = { channel: channel, amount: amount };
        var actual = encodeForSigningClaim(json);
        assert.equal(actual, [
            // hash prefix
            '434C4D00',
            // channel ID
...
//# sourceMappingURL=signing-data-encoding-test.js.map