...
var decodeAddress = require('../../address-codec/src').decodeAddress;
...
function computeTrustlineHash(address1, address2, currency) {
    ...
    var swap = (new BigNumber(address1Hex, 16)).greaterThan(new BigNumber(address2Hex, 16));
    var lowAddressHex = swap ? address2Hex : address1Hex;
    var highAddressHex = swap ? address1Hex : address2Hex;
    var prefix = ledgerSpaceHex('callState');
