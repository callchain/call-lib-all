...
var _require = require('./hash-prefixes'), HashPrefix = _require.HashPrefix;
var _require2 = require('./serdes/binary-parser'), BinaryParser = _require2.BinaryParser;
var _require3 = require('./serdes/binary-serializer'), BinarySerializer = _require3.BinarySerializer, BytesList = _require3.BytesList;
var _require4 = require('./utils/bytes-utils'), bytesToHex = _require4.bytesToHex, slice = _require4.slice, parseBytes = _require4.parseBytes;
var _require5 = require('./hashes'), sha512Half = _require5.sha512Half, transactionID = _require5.transactionID;
...
function serializeObject(object) {
    ...
    var prefix = opts.prefix, suffix = opts.suffix, _opts$signingFieldsOn = opts.signingFieldsOnly, signingFieldsOnly = _opts$signingFieldsOn === undefined ? false : _opts$signingFieldsOn;
...
function signingData(tx) {
    var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : HashPrefix.transactionSig;
