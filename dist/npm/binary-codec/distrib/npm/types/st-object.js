...
var _require = require('../enums'), Field = _require.Field;
var _require2 = require('../serdes/binary-serializer'), BinarySerializer = _require2.BinarySerializer;
var ObjectEndMarker = Field.ObjectEndMarker;
var _require3 = require('./serialized-type'), SerializedType = _require3.SerializedType;
var STObject = makeClass({
    ...
    toBytesSink: function toBytesSink(sink) {
        var _this = this;
        var filter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () { return true; };
