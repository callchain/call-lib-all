...
var _require2 = require('../utils/bytes-utils'), slice = _require2.slice, parseBytes = _require2.parseBytes;
var BinaryParser = makeClass({
    ...
    read: function read(n) {
        var to = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Uint8Array;
