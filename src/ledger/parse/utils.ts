...
// import transactionParser = require('transactionparser')
import transactionParser = require('../../transactionparser/src')
...
function parseTimestamp(callTime?: number|null): string|undefined {
